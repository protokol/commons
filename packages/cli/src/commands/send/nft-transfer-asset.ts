...
export default class NFTTransferAsset extends SendBase {
	public static override description = SendBase.defaultDescription + builders[TransactionType.NFTTransferAsset].name;
	...
	public override type = TransactionType.NFTTransferAsset;
